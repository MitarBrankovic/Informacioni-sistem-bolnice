...
namespace PrviProgram.Izgled.IzgledSekretar.Views
{
    public partial class PomeranjeTerminaView : Page
    {
        ...
        public PomeranjeTerminaView(ObservableCollection<Termin> sviTermini, ObservableCollection<Termin> termini, Termin termin)
        {
            InitializeComponent();
        ...
        private void Potvrdi_Click(object sender, RoutedEventArgs e)
        {
            ...
            Page zakazivanje = new ZakazivanjeTerminaView(new ObservableCollection<Termin>(terminiRepository.PregledSvihTermina()));
